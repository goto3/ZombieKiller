...
class CollisionEngine {
	...
	public static function renderDebug(canvas:kha.Canvas, camera:Camera) {
		...
		canvas.g2.transformation = FastMatrix3.scale(scaleX, scaleY)
			.multmat(new FastMatrix3(cV._00, cV._10, cV._30 + camera.width * 0.5, cV._01, cV._11, cV._31 + camera.height * 0.5, cV._03, cV._13, cV._33));
